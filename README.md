...
Исходные идеи, примеры и выводы подготовлены автором. Часть текста пояснений была автоматически отредактирована с помощью ИИ, чтобы сделать материал более связным и удобным для чтения в текстовом формате.
